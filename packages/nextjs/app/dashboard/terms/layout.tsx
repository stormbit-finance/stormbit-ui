      ...
      <div className="h-full max-w-[1920px] w-full flex flex-col px-9">
        <div className="flex text-white pt-[30px] max-h-full max-w-[320px] w-full items-center text-lg">
          <button
            ...
            className={`px-8 py-4 rounded-l-lg ${activeButton === "Deposited" ? "button-gradient" : "bg-[#2F2F2F] border border-[#444C6A]"}`}
          >
            Deposited
          </button>
          <button
            onClick={() => handleButtonClick("/dashboard/terms/managed", "Managed")}
            className={`px-8 py-4 rounded-r-lg ${activeButton === "Managed" ? "button-gradient" : "bg-[#2F2F2F] border border-[#444C6A]"}`}
          >
            Managed
          </button>
        </div>
