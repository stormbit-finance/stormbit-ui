...
function Profile() {
  return (
    <>
      <h1 className="text-4xl text-[#ffffff] font-bold">Profile and Settings</h1>
      <div className="flex gap-32">
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            <span className="text-[#ffffff] font-bold text-xl">Account number</span>
          ...
          <div className="flex flex-col gap-2">
            <span className="text-[#ffffff] font-bold text-xl">Email</span>
            <div className="flex gap-2">
        ...
        <div className="flex flex-col gap-6">
          <span className="text-xl text-[#ffffff] font-bold">Reputation and Credit Score</span>
      ...
      <div className="flex flex-col gap-3">
        <span className="text-[#ffffff] font-bold text-xl">Verification</span>
        <div className="flex p-5 items-center gap-8 bg-[#16182E] w-[1150px] h-[98px]">
